...
public abstract class ChatScreenMixin {
    ...
    private String commands$patchRemoveFormatting(String par1) {
    ...
    private String[] coammands$processAutoComplete(String[] suggestions) {
    ...
    private String commands$patchRemoveFormatting(String[] strs) {
